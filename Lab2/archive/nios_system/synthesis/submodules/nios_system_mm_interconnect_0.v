...
module nios_system_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> performance_counter_0_control_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // performance_counter_0_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> performance_counter_0_control_slave_agent:cp_channel
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> new_sdram_controller_0_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // new_sdram_controller_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire   [28:0] leds_s1_agent_m0_address;                                                           // LEDS_s1_agent:m0_address -> LEDS_s1_translator:uav_address
	...
	wire  [105:0] leds_s1_agent_rf_source_data;                                                       // LEDS_s1_agent:rf_source_data -> LEDS_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] leds_s1_agent_rsp_fifo_out_data;                                                    // LEDS_s1_agent_rsp_fifo:out_data -> LEDS_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> LEDS_s1_agent:cp_data
	...
	wire          performance_counter_0_control_slave_agent_rp_valid;                                 // performance_counter_0_control_slave_agent:rp_valid -> router_003:sink_valid
	wire  [104:0] performance_counter_0_control_slave_agent_rp_data;                                  // performance_counter_0_control_slave_agent:rp_data -> router_003:sink_data
	wire          performance_counter_0_control_slave_agent_rp_ready;                                 // router_003:sink_ready -> performance_counter_0_control_slave_agent:rp_ready
	wire          performance_counter_0_control_slave_agent_rp_startofpacket;                         // performance_counter_0_control_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          performance_counter_0_control_slave_agent_rp_endofpacket;                           // performance_counter_0_control_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [104:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] leds_s1_agent_rp_data;                                                              // LEDS_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [104:0] cmd_demux_src3_data;                                                                // cmd_demux:src3_data -> crosser:in_data
	wire          cmd_demux_src3_ready;                                                               // crosser:in_ready -> cmd_demux:src3_ready
	wire    [4:0] cmd_demux_src3_channel;                                                             // cmd_demux:src3_channel -> crosser:in_channel
	...
	wire  [104:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_003:sink0_data
	wire          crosser_out_ready;                                                                  // cmd_mux_003:sink0_ready -> crosser:out_ready
	wire    [4:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_003:sink0_channel
	...
	wire  [104:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_003:sink1_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_003:sink1_ready -> crosser_001:out_ready
	wire    [4:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_003:sink1_channel
	...
	wire  [104:0] rsp_demux_003_src0_data;                                                            // rsp_demux_003:src0_data -> crosser_002:in_data
	wire          rsp_demux_003_src0_ready;                                                           // crosser_002:in_ready -> rsp_demux_003:src0_ready
	wire    [4:0] rsp_demux_003_src0_channel;                                                         // rsp_demux_003:src0_channel -> crosser_002:in_channel
	...
	wire  [104:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink3_data
	wire          crosser_002_out_ready;                                                              // rsp_mux:sink3_ready -> crosser_002:out_ready
	wire    [4:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink3_channel
	...
	wire  [104:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> crosser_003:in_data
	wire          rsp_demux_003_src1_ready;                                                           // crosser_003:in_ready -> rsp_demux_003:src1_ready
	wire    [4:0] rsp_demux_003_src1_channel;                                                         // rsp_demux_003:src1_channel -> crosser_003:in_channel
	...
	wire   [33:0] new_sdram_controller_0_s1_agent_rdata_fifo_out_data;                                // new_sdram_controller_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data

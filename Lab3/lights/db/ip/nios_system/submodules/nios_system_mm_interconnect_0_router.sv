...
(
    ...
    localparam PAD4 = log2ceil(64'h10001048 - 64'h10001040); 
    localparam PAD5 = log2ceil(64'h10001050 - 64'h10001048); 
    // -------------------------------------------------------
    ...
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 29'h10001040  && write_transaction  ) begin
            src_channel = 6'b000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x10001048 .. 0x10001050 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 29'h10001048   ) begin

...
module nios_system_mm_interconnect_0 (
	...
	wire    [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> led_pwm_0_avalon_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> performance_counter_0_control_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire    [4:0] cmd_demux_src4_channel;                                                             // cmd_demux:src4_channel -> crosser:in_channel
	...
	wire    [4:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_004:sink0_channel
	...
	wire  [104:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_004:sink1_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_004:sink1_ready -> crosser_001:out_ready
	wire    [4:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_004:sink1_channel
	...
	wire  [104:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> crosser_002:in_data
	wire          rsp_demux_004_src0_ready;                                                           // crosser_002:in_ready -> rsp_demux_004:src0_ready
	wire    [4:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_002:in_channel
	...
	wire  [104:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink4_data
	wire          crosser_002_out_ready;                                                              // rsp_mux:sink4_ready -> crosser_002:out_ready
	wire    [4:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink4_channel
	...
	wire  [104:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> crosser_003:in_data
	wire          rsp_demux_004_src1_ready;                                                           // crosser_003:in_ready -> rsp_demux_004:src1_ready
	wire    [4:0] rsp_demux_004_src1_channel;                                                         // rsp_demux_004:src1_channel -> crosser_003:in_channel
	...
	wire    [4:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink1_channel
